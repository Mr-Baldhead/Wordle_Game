...
app.get('/api/random-word', async (req: Request, res: Response): Promise<void> => {
  try {
...
// Hantera en gissning
app.post('/api/game/guess', (req: Request, res: Response): void => {
  try {
...
// Ge upp spelet
app.post('/api/game/end', (req: Request, res: Response): void => {
  try {
...
app.post('/api/highscores', async (req: Request, res: Response): Promise<void> => {
  try {
...
app.get('/highscores', async (req, res) => {
  try {
    ...
    const lettersFilter = req.query.letters ? parseInt(req.query.letters as string) : null;
